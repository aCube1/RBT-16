...
static const SST_RamByte subxl_initial_ram_16[] = {
		{ .addr = 0x50e5a6, .byte = 0x9f },
		{ .addr = 0x50e5a7, .byte = 0x89 },
		{ .addr = 0x50e5a8, .byte = 0x5f },
		{ .addr = 0x50e5a9, .byte = 0x9f },
		{ .addr = 0xc9599a, .byte = 0x75 },
		{ .addr = 0xc9599b, .byte = 0xd9 },
		{ .addr = 0xc95998, .byte = 0xac },
		{ .addr = 0xc95999, .byte = 0xa7 },
		{ .addr = 0xd3f036, .byte = 0x72 },
		{ .addr = 0xd3f037, .byte = 0xb5 },
		{ .addr = 0xd3f034, .byte = 0xea },
		{ .addr = 0xd3f035, .byte = 0x11 },
		{ .addr = 0x50e5aa, .byte = 0x24 },
		{ .addr = 0x50e5ab, .byte = 0x9f }
};

static const SST_RamByte subxl_final_ram_16[] = {
		{ .addr = 0x50e5a6, .byte = 0x9f },
		{ .addr = 0x50e5a7, .byte = 0x89 },
		{ .addr = 0x50e5a8, .byte = 0x5f },
		{ .addr = 0x50e5a9, .byte = 0x9f },
		...
		{ .addr = 0xc95998, .byte = 0xac },
		{ .addr = 0xc95999, .byte = 0xa7 },
		{ .addr = 0xd3f036, .byte = 0xfc },
		{ .addr = 0xd3f037, .byte = 0xdb },
		{ .addr = 0xd3f034, .byte = 0x3d },
		{ .addr = 0xd3f035, .byte = 0x69 },
		{ .addr = 0x50e5aa, .byte = 0x24 },
		{ .addr = 0x50e5ab, .byte = 0x9f }
};

static const SST_Transaction subxl_transactions_16[] = {
	{ .kind = SST_TS_N, .cycles = 2 },
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 1, .addr = 13195674, .data = 30169, .uds = true, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 1, .addr = 13195672, .data = 44199, .uds = true, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 1, .addr = 13889590, .data = 29365, .uds = true, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 1, .addr = 13889588, .data = 59921, .uds = true, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 1, .addr = 13889590, .data = 64731, .uds = true, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 2, .addr = 5301674, .data = 9375, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 1, .addr = 13889588, .data = 15721, .uds = true, .lds = false, .is_word = false, 
		}
	},
};

static const SST_RamByte subxl_initial_ram_17[] = {
		{ .addr = 0xed42ae, .byte = 0x9f },
		{ .addr = 0xed42af, .byte = 0x89 },
		{ .addr = 0xed42b0, .byte = 0x7e },
		{ .addr = 0xed42b1, .byte = 0x9d },
		{ .addr = 0x00000c, .byte = 0xfd },
		{ .addr = 0x00000d, .byte = 0x3c },
		{ .addr = 0x00000e, .byte = 0xec },
		{ .addr = 0x00000f, .byte = 0x8e },
		{ .addr = 0x3cec8e, .byte = 0x31 },
		{ .addr = 0x3cec8f, .byte = 0xb8 },
		{ .addr = 0x3cec90, .byte = 0x8a },
		{ .addr = 0x3cec91, .byte = 0x25 }
};

static const SST_RamByte subxl_final_ram_17[] = {
		{ .addr = 0xed42ae, .byte = 0x9f },
		{ .addr = 0xed42af, .byte = 0x89 },
		{ .addr = 0xed42b0, .byte = 0x7e },
		{ .addr = 0xed42b1, .byte = 0x9d },
		{ .addr = 0x21cd3c, .byte = 0x42 },
		{ .addr = 0x21cd3d, .byte = 0xb2 },
		{ .addr = 0x21cd38, .byte = 0x20 },
		{ .addr = 0x21cd39, .byte = 0x00 },
		{ .addr = 0x21cd3a, .byte = 0x00 },
		{ .addr = 0x21cd3b, .byte = 0xed },
		{ .addr = 0x21cd36, .byte = 0x9f },
		{ .addr = 0x21cd37, .byte = 0x89 },
		{ .addr = 0x21cd34, .byte = 0xef },
		{ .addr = 0x21cd35, .byte = 0xbb },
		{ .addr = 0x21cd30, .byte = 0x9f },
		{ .addr = 0x21cd31, .byte = 0x95 },
		{ .addr = 0x21cd32, .byte = 0xce },
		{ .addr = 0x21cd33, .byte = 0x1e },
		{ .addr = 0x00000c, .byte = 0xfd },
		{ .addr = 0x00000d, .byte = 0x3c },
		{ .addr = 0x00000e, .byte = 0xec },
		{ .addr = 0x00000f, .byte = 0x8e },
...
static const SST_Transaction subxl_transactions_17[] = {
	{ .kind = SST_TS_N, .cycles = 2 },
	{
		.kind = SST_TS_RE,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 2027450, .data = 19160, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 8 },
	{
		...
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 2215228, .data = 17074, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 2215224, .data = 8192, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 2215226, .data = 237, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 2215222, .data = 40841, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 2215220, .data = 61371, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 2215216, .data = 40853, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 2215218, .data = 52766, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 12, .data = 64828, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 14, .data = 60558, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 3992718, .data = 12728, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 2 },
	{
		...
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 3992720, .data = 35365, .uds = false, .lds = false, .is_word = false, 
		}
	},
};

static const SST_RamByte subxl_initial_ram_18[] = {
		{ .addr = 0x9929d4, .byte = 0x99 },
		{ .addr = 0x9929d5, .byte = 0x81 },
		{ .addr = 0x9929d6, .byte = 0x2b },
		{ .addr = 0x9929d7, .byte = 0x77 },
		{ .addr = 0x9929d8, .byte = 0xf1 },
		{ .addr = 0x9929d9, .byte = 0x3d }
};

static const SST_RamByte subxl_final_ram_18[] = {
		{ .addr = 0x9929d4, .byte = 0x99 },
		{ .addr = 0x9929d5, .byte = 0x81 },
		{ .addr = 0x9929d6, .byte = 0x2b },
		{ .addr = 0x9929d7, .byte = 0x77 },
...
static const SST_Transaction subxl_transactions_18[] = {
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 2, .addr = 10037720, .data = 61757, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 4 },
};

static const SST_RamByte subxl_initial_ram_19[] = {
		{ .addr = 0x6d315a, .byte = 0x93 },
		{ .addr = 0x6d315b, .byte = 0x8b },
		{ .addr = 0x6d315c, .byte = 0x39 },
		{ .addr = 0x6d315d, .byte = 0x84 },
		{ .addr = 0xfccd44, .byte = 0x48 },
		{ .addr = 0xfccd45, .byte = 0xf6 },
		{ .addr = 0xfccd42, .byte = 0x81 },
		{ .addr = 0xfccd43, .byte = 0x5d },
		{ .addr = 0x00000c, .byte = 0x57 },
		{ .addr = 0x00000d, .byte = 0x58 },
		{ .addr = 0x00000e, .byte = 0x1c },
		{ .addr = 0x00000f, .byte = 0x8c },
		{ .addr = 0x581c8c, .byte = 0xf7 },
		{ .addr = 0x581c8d, .byte = 0x76 },
		{ .addr = 0x581c8e, .byte = 0xd1 },
		{ .addr = 0x581c8f, .byte = 0xbe }
};

static const SST_RamByte subxl_final_ram_19[] = {
		{ .addr = 0x6d315a, .byte = 0x93 },
		{ .addr = 0x6d315b, .byte = 0x8b },
		{ .addr = 0x6d315c, .byte = 0x39 },
		{ .addr = 0x6d315d, .byte = 0x84 },
		...
		{ .addr = 0xfccd42, .byte = 0x81 },
		{ .addr = 0xfccd43, .byte = 0x5d },
		{ .addr = 0x4ea45a, .byte = 0x31 },
		{ .addr = 0x4ea45b, .byte = 0x5e },
		{ .addr = 0x4ea456, .byte = 0xa3 },
		{ .addr = 0x4ea457, .byte = 0x05 },
		{ .addr = 0x4ea458, .byte = 0x00 },
		{ .addr = 0x4ea459, .byte = 0x6d },
		{ .addr = 0x4ea454, .byte = 0x93 },
		{ .addr = 0x4ea455, .byte = 0x8b },
		{ .addr = 0x4ea452, .byte = 0x01 },
		{ .addr = 0x4ea453, .byte = 0x5f },
		{ .addr = 0x4ea44e, .byte = 0x93 },
		{ .addr = 0x4ea44f, .byte = 0x95 },
		{ .addr = 0x4ea450, .byte = 0x9a },
		{ .addr = 0x4ea451, .byte = 0x6d },
		{ .addr = 0x00000c, .byte = 0x57 },
		{ .addr = 0x00000d, .byte = 0x58 },
		{ .addr = 0x00000e, .byte = 0x1c },
		{ .addr = 0x00000f, .byte = 0x8c },
...
static const SST_Transaction subxl_transactions_19[] = {
	{ .kind = SST_TS_N, .cycles = 2 },
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 16567620, .data = 18678, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 16567618, .data = 33117, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_RE,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 7143774, .data = 22637, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 8 },
	{
		...
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 5153882, .data = 12638, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 5153878, .data = 41733, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 5153880, .data = 109, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 5153876, .data = 37771, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 5153874, .data = 351, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 5153870, .data = 37781, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 5153872, .data = 39533, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 12, .data = 22360, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 14, .data = 7308, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 5774476, .data = 63350, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 2 },
	{
		...
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 5774478, .data = 53694, .uds = false, .lds = false, .is_word = false, 
		}
	},
};

static const SST_RamByte subxl_initial_ram_20[] = {
		{ .addr = 0x9e4a86, .byte = 0x99 },
		{ .addr = 0x9e4a87, .byte = 0x82 },
		{ .addr = 0x9e4a88, .byte = 0x4e },
		{ .addr = 0x9e4a89, .byte = 0x1b },
		{ .addr = 0x9e4a8a, .byte = 0x92 },
		{ .addr = 0x9e4a8b, .byte = 0xf4 }
};

static const SST_RamByte subxl_final_ram_20[] = {
		{ .addr = 0x9e4a86, .byte = 0x99 },
		{ .addr = 0x9e4a87, .byte = 0x82 },
		{ .addr = 0x9e4a88, .byte = 0x4e },
		{ .addr = 0x9e4a89, .byte = 0x1b },
...
static const SST_Transaction subxl_transactions_20[] = {
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 2, .addr = 10373770, .data = 37620, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 4 },
};

static const SST_RamByte subxl_initial_ram_21[] = {
		{ .addr = 0xd6f702, .byte = 0x99 },
		{ .addr = 0xd6f703, .byte = 0x80 },
		{ .addr = 0xd6f704, .byte = 0xb9 },
		{ .addr = 0xd6f705, .byte = 0x61 },
		{ .addr = 0xd6f706, .byte = 0x4d },
		{ .addr = 0xd6f707, .byte = 0x12 }
};

static const SST_RamByte subxl_final_ram_21[] = {
		{ .addr = 0xd6f702, .byte = 0x99 },
		{ .addr = 0xd6f703, .byte = 0x80 },
		{ .addr = 0xd6f704, .byte = 0xb9 },
		{ .addr = 0xd6f705, .byte = 0x61 },
...
static const SST_Transaction subxl_transactions_21[] = {
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 2, .addr = 14087942, .data = 19730, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 4 },
};

static const SST_RamByte subxl_initial_ram_22[] = {
		{ .addr = 0x153f4a, .byte = 0x9d },
		{ .addr = 0x153f4b, .byte = 0x84 },
		{ .addr = 0x153f4c, .byte = 0x0f },
		{ .addr = 0x153f4d, .byte = 0xef },
		{ .addr = 0x153f4e, .byte = 0x79 },
		{ .addr = 0x153f4f, .byte = 0x7e }
};

static const SST_RamByte subxl_final_ram_22[] = {
		{ .addr = 0x153f4a, .byte = 0x9d },
		{ .addr = 0x153f4b, .byte = 0x84 },
		{ .addr = 0x153f4c, .byte = 0x0f },
		{ .addr = 0x153f4d, .byte = 0xef },
...
static const SST_Transaction subxl_transactions_22[] = {
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 1392462, .data = 31102, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 4 },
};

static const SST_RamByte subxl_initial_ram_23[] = {
		{ .addr = 0x2c4f50, .byte = 0x97 },
		{ .addr = 0x2c4f51, .byte = 0x84 },
		{ .addr = 0x2c4f52, .byte = 0x52 },
		{ .addr = 0x2c4f53, .byte = 0x53 },
		{ .addr = 0x2c4f54, .byte = 0x4e },
		{ .addr = 0x2c4f55, .byte = 0x30 }
};

static const SST_RamByte subxl_final_ram_23[] = {
		{ .addr = 0x2c4f50, .byte = 0x97 },
		{ .addr = 0x2c4f51, .byte = 0x84 },
		{ .addr = 0x2c4f52, .byte = 0x52 },
		{ .addr = 0x2c4f53, .byte = 0x53 },
...
static const SST_Transaction subxl_transactions_23[] = {
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 2903892, .data = 20016, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 4 },
};

static const SST_RamByte subxl_initial_ram_24[] = {
		{ .addr = 0x71c4dc, .byte = 0x93 },
		{ .addr = 0x71c4dd, .byte = 0x80 },
		{ .addr = 0x71c4de, .byte = 0x3b },
		{ .addr = 0x71c4df, .byte = 0x4d },
		{ .addr = 0x71c4e0, .byte = 0x26 },
		{ .addr = 0x71c4e1, .byte = 0x48 }
};

static const SST_RamByte subxl_final_ram_24[] = {
		{ .addr = 0x71c4dc, .byte = 0x93 },
		{ .addr = 0x71c4dd, .byte = 0x80 },
		{ .addr = 0x71c4de, .byte = 0x3b },
		{ .addr = 0x71c4df, .byte = 0x4d },
...
static const SST_Transaction subxl_transactions_24[] = {
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 7455968, .data = 9800, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 4 },
};

static const SST_RamByte subxl_initial_ram_25[] = {
		{ .addr = 0xf6b5ea, .byte = 0x93 },
		{ .addr = 0xf6b5eb, .byte = 0x8b },
		{ .addr = 0xf6b5ec, .byte = 0xef },
		{ .addr = 0xf6b5ed, .byte = 0x9b },
		{ .addr = 0x00000c, .byte = 0xf9 },
		{ .addr = 0x00000d, .byte = 0x42 },
		{ .addr = 0x00000e, .byte = 0x2c },
		{ .addr = 0x00000f, .byte = 0xd8 },
		{ .addr = 0x422cd8, .byte = 0x12 },
		{ .addr = 0x422cd9, .byte = 0x4d },
		{ .addr = 0x422cda, .byte = 0xda },
		{ .addr = 0x422cdb, .byte = 0xf5 }
};

static const SST_RamByte subxl_final_ram_25[] = {
		{ .addr = 0xf6b5ea, .byte = 0x93 },
		{ .addr = 0xf6b5eb, .byte = 0x8b },
		{ .addr = 0xf6b5ec, .byte = 0xef },
		{ .addr = 0xf6b5ed, .byte = 0x9b },
		{ .addr = 0xccf982, .byte = 0xb5 },
		{ .addr = 0xccf983, .byte = 0xee },
		{ .addr = 0xccf97e, .byte = 0x22 },
		{ .addr = 0xccf97f, .byte = 0x0f },
		{ .addr = 0xccf980, .byte = 0x00 },
		{ .addr = 0xccf981, .byte = 0xf6 },
		{ .addr = 0xccf97c, .byte = 0x93 },
		{ .addr = 0xccf97d, .byte = 0x8b },
		{ .addr = 0xccf97a, .byte = 0x99 },
		{ .addr = 0xccf97b, .byte = 0x5d },
		{ .addr = 0xccf976, .byte = 0x93 },
		{ .addr = 0xccf977, .byte = 0x95 },
		{ .addr = 0xccf978, .byte = 0x11 },
		{ .addr = 0xccf979, .byte = 0xd7 },
		{ .addr = 0x00000c, .byte = 0xf9 },
		{ .addr = 0x00000d, .byte = 0x42 },
		{ .addr = 0x00000e, .byte = 0x2c },
		{ .addr = 0x00000f, .byte = 0xd8 },
...
static const SST_Transaction subxl_transactions_25[] = {
	{ .kind = SST_TS_N, .cycles = 2 },
	{
		.kind = SST_TS_RE,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 14129500, .data = 34316, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 8 },
	{
		...
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 13433218, .data = 46574, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 13433214, .data = 8719, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 13433216, .data = 246, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 13433212, .data = 37771, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 13433210, .data = 39261, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 13433206, .data = 37781, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 13433208, .data = 4567, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 12, .data = 63810, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 14, .data = 11480, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 4336856, .data = 4685, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 2 },
	{
		...
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 4336858, .data = 56053, .uds = false, .lds = false, .is_word = false, 
		}
	},
};

static const SST_RamByte subxl_initial_ram_26[] = {
		{ .addr = 0xd6b32c, .byte = 0x99 },
		{ .addr = 0xd6b32d, .byte = 0x80 },
		{ .addr = 0xd6b32e, .byte = 0x43 },
		{ .addr = 0xd6b32f, .byte = 0xb2 },
		{ .addr = 0xd6b330, .byte = 0xf9 },
		{ .addr = 0xd6b331, .byte = 0x11 }
};

static const SST_RamByte subxl_final_ram_26[] = {
		{ .addr = 0xd6b32c, .byte = 0x99 },
		{ .addr = 0xd6b32d, .byte = 0x80 },
		{ .addr = 0xd6b32e, .byte = 0x43 },
		{ .addr = 0xd6b32f, .byte = 0xb2 },
...
static const SST_Transaction subxl_transactions_26[] = {
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 14070576, .data = 63761, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 4 },
};

static const SST_RamByte subxl_initial_ram_27[] = {
		{ .addr = 0x9fc07a, .byte = 0x97 },
		{ .addr = 0x9fc07b, .byte = 0x87 },
		{ .addr = 0x9fc07c, .byte = 0xbc },
		{ .addr = 0x9fc07d, .byte = 0xb3 },
		{ .addr = 0x9fc07e, .byte = 0xa1 },
		{ .addr = 0x9fc07f, .byte = 0x66 }
};

static const SST_RamByte subxl_final_ram_27[] = {
		{ .addr = 0x9fc07a, .byte = 0x97 },
		{ .addr = 0x9fc07b, .byte = 0x87 },
		{ .addr = 0x9fc07c, .byte = 0xbc },
		{ .addr = 0x9fc07d, .byte = 0xb3 },
...
static const SST_Transaction subxl_transactions_27[] = {
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 2, .addr = 10469502, .data = 41318, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 4 },
};

static const SST_RamByte subxl_initial_ram_28[] = {
		{ .addr = 0x540d3c, .byte = 0x9d },
		{ .addr = 0x540d3d, .byte = 0x8d },
		{ .addr = 0x540d3e, .byte = 0xf8 },
		{ .addr = 0x540d3f, .byte = 0x6e },
		{ .addr = 0x067c9c, .byte = 0x5d },
		{ .addr = 0x067c9d, .byte = 0x07 },
		{ .addr = 0x067c9a, .byte = 0x48 },
		{ .addr = 0x067c9b, .byte = 0x5b },
		{ .addr = 0x00000c, .byte = 0xa2 },
		{ .addr = 0x00000d, .byte = 0x20 },
		{ .addr = 0x00000e, .byte = 0x11 },
		{ .addr = 0x00000f, .byte = 0x58 },
		{ .addr = 0x201158, .byte = 0xe5 },
		{ .addr = 0x201159, .byte = 0x14 },
		{ .addr = 0x20115a, .byte = 0xe4 },
		{ .addr = 0x20115b, .byte = 0xce }
};

static const SST_RamByte subxl_final_ram_28[] = {
		{ .addr = 0x540d3c, .byte = 0x9d },
		{ .addr = 0x540d3d, .byte = 0x8d },
		{ .addr = 0x540d3e, .byte = 0xf8 },
		{ .addr = 0x540d3f, .byte = 0x6e },
		...
		{ .addr = 0x067c9a, .byte = 0x48 },
		{ .addr = 0x067c9b, .byte = 0x5b },
		{ .addr = 0x01aa42, .byte = 0x0d },
		{ .addr = 0x01aa43, .byte = 0x40 },
		{ .addr = 0x01aa3e, .byte = 0x20 },
		{ .addr = 0x01aa3f, .byte = 0x0d },
		{ .addr = 0x01aa40, .byte = 0x00 },
		{ .addr = 0x01aa41, .byte = 0x54 },
		{ .addr = 0x01aa3c, .byte = 0x9d },
		{ .addr = 0x01aa3d, .byte = 0x8d },
		{ .addr = 0x01aa3a, .byte = 0x0d },
		{ .addr = 0x01aa3b, .byte = 0x73 },
		{ .addr = 0x01aa36, .byte = 0x9d },
		{ .addr = 0x01aa37, .byte = 0x95 },
		{ .addr = 0x01aa38, .byte = 0x6d },
		{ .addr = 0x01aa39, .byte = 0x6a },
		{ .addr = 0x00000c, .byte = 0xa2 },
		{ .addr = 0x00000d, .byte = 0x20 },
		{ .addr = 0x00000e, .byte = 0x11 },
		{ .addr = 0x00000f, .byte = 0x58 },
...
static const SST_Transaction subxl_transactions_28[] = {
	{ .kind = SST_TS_N, .cycles = 2 },
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 425116, .data = 23815, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 425114, .data = 18523, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_RE,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 6950258, .data = 52377, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 8 },
	{
		...
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 109122, .data = 3392, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 109118, .data = 8205, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 109120, .data = 84, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 109116, .data = 40333, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 109114, .data = 3443, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 109110, .data = 40341, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 109112, .data = 28010, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 12, .data = 41504, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 14, .data = 4440, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 2101592, .data = 58644, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 2 },
	{
		...
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 2101594, .data = 58574, .uds = false, .lds = false, .is_word = false, 
		}
	},
};

static const SST_RamByte subxl_initial_ram_29[] = {
		{ .addr = 0xaf0462, .byte = 0x99 },
		{ .addr = 0xaf0463, .byte = 0x8c },
		{ .addr = 0xaf0464, .byte = 0x7b },
		{ .addr = 0xaf0465, .byte = 0x21 },
		{ .addr = 0x00000c, .byte = 0xa7 },
		{ .addr = 0x00000d, .byte = 0xa8 },
		{ .addr = 0x00000e, .byte = 0xe6 },
		{ .addr = 0x00000f, .byte = 0x0e },
		{ .addr = 0xa8e60e, .byte = 0xc0 },
		{ .addr = 0xa8e60f, .byte = 0x90 },
		{ .addr = 0xa8e610, .byte = 0xb8 },
		{ .addr = 0xa8e611, .byte = 0x60 }
};

static const SST_RamByte subxl_final_ram_29[] = {
		{ .addr = 0xaf0462, .byte = 0x99 },
		{ .addr = 0xaf0463, .byte = 0x8c },
		{ .addr = 0xaf0464, .byte = 0x7b },
		{ .addr = 0xaf0465, .byte = 0x21 },
		{ .addr = 0x6857b4, .byte = 0x04 },
		{ .addr = 0x6857b5, .byte = 0x66 },
		{ .addr = 0x6857b0, .byte = 0x04 },
		{ .addr = 0x6857b1, .byte = 0x09 },
		{ .addr = 0x6857b2, .byte = 0x00 },
		{ .addr = 0x6857b3, .byte = 0xaf },
		{ .addr = 0x6857ae, .byte = 0x99 },
		{ .addr = 0x6857af, .byte = 0x8c },
		{ .addr = 0x6857ac, .byte = 0x7a },
		{ .addr = 0x6857ad, .byte = 0x73 },
		{ .addr = 0x6857a8, .byte = 0x99 },
		{ .addr = 0x6857a9, .byte = 0x91 },
		{ .addr = 0x6857aa, .byte = 0xe6 },
		{ .addr = 0x6857ab, .byte = 0x35 },
		{ .addr = 0x00000c, .byte = 0xa7 },
		{ .addr = 0x00000d, .byte = 0xa8 },
		{ .addr = 0x00000e, .byte = 0xe6 },
		{ .addr = 0x00000f, .byte = 0x0e },
...
static const SST_Transaction subxl_transactions_29[] = {
	{ .kind = SST_TS_N, .cycles = 2 },
	{
		.kind = SST_TS_RE,
		.cycles = 4,
		.bus = {
			.fc = 1, .addr = 3504754, .data = 6333, .uds = true, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 8 },
	{
		...
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 6838196, .data = 1126, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 6838192, .data = 1033, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 6838194, .data = 175, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 6838190, .data = 39308, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 6838188, .data = 31347, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 6838184, .data = 39313, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 6838186, .data = 58933, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 12, .data = 42920, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 14, .data = 58894, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 11068942, .data = 49296, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 2 },
	{
		...
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 11068944, .data = 47200, .uds = false, .lds = false, .is_word = false, 
		}
	},
};

static const SST_RamByte subxl_initial_ram_30[] = {
		{ .addr = 0x2c1fbe, .byte = 0x91 },
		{ .addr = 0x2c1fbf, .byte = 0x80 },
		{ .addr = 0x2c1fc0, .byte = 0x34 },
		{ .addr = 0x2c1fc1, .byte = 0xf0 },
		{ .addr = 0x2c1fc2, .byte = 0xd5 },
		{ .addr = 0x2c1fc3, .byte = 0x3b }
};

static const SST_RamByte subxl_final_ram_30[] = {
		{ .addr = 0x2c1fbe, .byte = 0x91 },
		{ .addr = 0x2c1fbf, .byte = 0x80 },
		{ .addr = 0x2c1fc0, .byte = 0x34 },
		{ .addr = 0x2c1fc1, .byte = 0xf0 },
...
static const SST_Transaction subxl_transactions_30[] = {
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 2891714, .data = 54587, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 4 },
};

static const SST_RamByte subxl_initial_ram_31[] = {
		{ .addr = 0xfaae06, .byte = 0x93 },
		{ .addr = 0xfaae07, .byte = 0x87 },
		{ .addr = 0xfaae08, .byte = 0x94 },
		{ .addr = 0xfaae09, .byte = 0x3a },
		{ .addr = 0xfaae0a, .byte = 0xb9 },
		{ .addr = 0xfaae0b, .byte = 0x06 }
};

static const SST_RamByte subxl_final_ram_31[] = {
		{ .addr = 0xfaae06, .byte = 0x93 },
		{ .addr = 0xfaae07, .byte = 0x87 },
		{ .addr = 0xfaae08, .byte = 0x94 },
		{ .addr = 0xfaae09, .byte = 0x3a },
...
static const SST_Transaction subxl_transactions_31[] = {
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 2, .addr = 16428554, .data = 47366, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 4 },
};
...
static const SST_TestCase subxl[] = {
	...
	{
		.name = "016 SUBX.l -(A1), -(A7) 9f89",
		.initial = {
			.regs = {
				2518540990, 3067869179, 1304390304, 3331734060, 1999670926, 2299221186, 4117544438, 2990123832, 4278420807, 2194233756, 1454007698, 194872336, 1840745632, 1869722449, 1856491389, 13889592, 6175576, 34332, 5301674
			},
			.prefetch0 = 40841,
			.prefetch1 = 24479,
			.ram = subxl_initial_ram_16,
			.ram_len = 14,
		},
		.final = {
			.regs = {
				2518540990, 3067869179, 1304390304, 3331734060, 1999670926, 2299221186, 4117544438, 2990123832, 4278420807, 2194233752, 1454007698, 194872336, 1840745632, 1869722449, 1856491389, 13889588, 6175576, 34304, 5301676
			},
			.prefetch0 = 24479,
			.prefetch1 = 9375,
			.ram = subxl_final_ram_16,
			.ram_len = 14,
		},
		.transactions = subxl_transactions_16,
		.transactions_len = 8,
		.lenght = 30,
	},
	{
		.name = "017 SUBX.l -(A1), -(A7) 9f89",
		.initial = {
			.regs = {
				826922168, 4043278374, 225762814, 2704579179, 3654959370, 874458586, 2531160239, 1493425230, 3669494590, 3458133949, 912140748, 3838080800, 1170137557, 3293763340, 495183213, 15929348, 2215230, 8192, 15549106
			},
			.prefetch0 = 40841,
			.prefetch1 = 32413,
			.ram = subxl_initial_ram_17,
			.ram_len = 12,
		},
		.final = {
			.regs = {
				826922168, 4043278374, 225762814, 2704579179, 3654959370, 874458586, 2531160239, 1493425230, 3669494590, 3458133949, 912140748, 3838080800, 1170137557, 3293763340, 495183213, 15929348, 2215216, 8192, 4248628370
			},
			.prefetch0 = 12728,
			.prefetch1 = 35365,
			.ram = subxl_final_ram_17,
			.ram_len = 26,
		},
		.transactions = subxl_transactions_17,
		.transactions_len = 15,
		.lenght = 60,
	},
	{
		.name = "018 SUBX.l D1, D4 9981",
		.initial = {
			.regs = {
				2983907912, 2972089849, 363532317, 3668314118, 3933409664, 1118210009, 3245599672, 1734564243, 2132593272, 1324208556, 55520143, 825010469, 899656007, 1946847089, 1293464109, 7239716, 1924070, 33810, 10037720
			},
			.prefetch0 = 39297,
			.prefetch1 = 11127,
			.ram = subxl_initial_ram_18,
			.ram_len = 6,
		},
		.final = {
			.regs = {
				2983907912, 2972089849, 363532317, 3668314118, 961319814, 1118210009, 3245599672, 1734564243, 2132593272, 1324208556, 55520143, 825010469, 899656007, 1946847089, 1293464109, 7239716, 1924070, 33792, 10037722
			},
			.prefetch0 = 11127,
			.prefetch1 = 61757,
			.ram = subxl_final_ram_18,
			.ram_len = 6,
		},
		.transactions = subxl_transactions_18,
		.transactions_len = 2,
		.lenght = 8,
	},
	{
		.name = "019 SUBX.l -(A3), -(A1) 938b",
		.initial = {
			.regs = {
				1729503005, 2798701522, 2980670729, 2975472672, 1154560398, 2049184498, 3844619009, 1483936507, 1536794311, 2590835041, 2459114706, 4059876678, 2806339699, 3456448633, 3841016561, 6922912, 5153884, 41733, 7156062
			},
			.prefetch0 = 37771,
			.prefetch1 = 14724,
			.ram = subxl_initial_ram_19,
			.ram_len = 16,
		},
		.final = {
			.regs = {
				1729503005, 2798701522, 2980670729, 2975472672, 1154560398, 2049184498, 3844619009, 1483936507, 1536794311, 2590835041, 2459114706, 4059876674, 2806339699, 3456448633, 3841016561, 6922912, 5153870, 8965, 1465392272
			},
			.prefetch0 = 63350,
			.prefetch1 = 53694,
			.ram = subxl_final_ram_19,
			.ram_len = 30,
		},
		.transactions = subxl_transactions_19,
		.transactions_len = 17,
		.lenght = 68,
	},
	{
		.name = "020 SUBX.l D2, D4 9982",
		.initial = {
			.regs = {
				275918035, 1410934607, 3506258034, 3892399567, 2152072373, 741485373, 3580267192, 595153674, 1669765394, 2859433349, 2517714041, 227009643, 3951077449, 3712111170, 3097289571, 5021048, 10662358, 33537, 10373770
			},
			.prefetch0 = 39298,
			.prefetch1 = 19995,
			.ram = subxl_initial_ram_20,
			.ram_len = 6,
		},
		.final = {
			.regs = {
				275918035, 1410934607, 3506258034, 3892399567, 2940781635, 741485373, 3580267192, 595153674, 1669765394, 2859433349, 2517714041, 227009643, 3951077449, 3712111170, 3097289571, 5021048, 10662358, 33561, 10373772
			},
			.prefetch0 = 19995,
			.prefetch1 = 37620,
			.ram = subxl_final_ram_20,
			.ram_len = 6,
		},
		.transactions = subxl_transactions_20,
		.transactions_len = 2,
		.lenght = 8,
	},
	{
		.name = "021 SUBX.l D0, D4 9980",
		.initial = {
			.regs = {
				2236204970, 2090898587, 2398895971, 2264973493, 488721630, 2569730606, 562301718, 2718243242, 1888379330, 1608002594, 2530469517, 3319594416, 3205250366, 1039533809, 1492833217, 9948562, 12966850, 798, 14087942
			},
			.prefetch0 = 39296,
			.prefetch1 = 47457,
			.ram = subxl_initial_ram_21,
			.ram_len = 6,
		},
		.final = {
			.regs = {
				2236204970, 2090898587, 2398895971, 2264973493, 2547483955, 2569730606, 562301718, 2718243242, 1888379330, 1608002594, 2530469517, 3319594416, 3205250366, 1039533809, 1492833217, 9948562, 12966850, 795, 14087944
			},
			.prefetch0 = 47457,
			.prefetch1 = 19730,
			.ram = subxl_final_ram_21,
			.ram_len = 6,
		},
		.transactions = subxl_transactions_21,
		.transactions_len = 2,
		.lenght = 8,
	},
	{
		.name = "022 SUBX.l D4, D6 9d84",
		.initial = {
			.regs = {
				3519168387, 400298948, 2581229213, 2311691466, 4258060166, 3538355027, 1128339866, 4289471956, 2367995322, 2459245399, 1486548936, 728209345, 1907541908, 1258347476, 2806453702, 9491016, 5587658, 9242, 1392462
			},
			.prefetch0 = 40324,
			.prefetch1 = 4079,
			.ram = subxl_initial_ram_22,
			.ram_len = 6,
		},
		.final = {
			.regs = {
				3519168387, 400298948, 2581229213, 2311691466, 4258060166, 3538355027, 1165246995, 4289471956, 2367995322, 2459245399, 1486548936, 728209345, 1907541908, 1258347476, 2806453702, 9491016, 5587658, 9233, 1392464
			},
			.prefetch0 = 4079,
			.prefetch1 = 31102,
			.ram = subxl_final_ram_22,
			.ram_len = 6,
		},
		.transactions = subxl_transactions_22,
		.transactions_len = 2,
		.lenght = 8,
	},
	{
		.name = "023 SUBX.l D4, D3 9784",
		.initial = {
			.regs = {
				3300712096, 2698503876, 2106388200, 388398871, 1728947194, 2774143023, 363387535, 317598163, 1117046339, 4116707165, 2951909178, 3085102904, 830003388, 1821838457, 746461177, 15981976, 8121978, 9729, 2903892
			},
			.prefetch0 = 38788,
			.prefetch1 = 21075,
			.ram = subxl_initial_ram_23,
			.ram_len = 6,
		},
		.final = {
			.regs = {
				3300712096, 2698503876, 2106388200, 2954418973, 1728947194, 2774143023, 363387535, 317598163, 1117046339, 4116707165, 2951909178, 3085102904, 830003388, 1821838457, 746461177, 15981976, 8121978, 9753, 2903894
			},
			.prefetch0 = 21075,
			.prefetch1 = 20016,
			.ram = subxl_final_ram_23,
			.ram_len = 6,
		},
		.transactions = subxl_transactions_23,
		.transactions_len = 2,
		.lenght = 8,
	},
	{
		.name = "024 SUBX.l D0, D1 9380",
		.initial = {
			.regs = {
				1912792442, 3927263317, 190922587, 2322231910, 4005525452, 1537634926, 3830746880, 1298310455, 724739979, 483854543, 3485735879, 2677682084, 3698513350, 1918455832, 2348599577, 14188284, 8031770, 8207, 7455968
			},
			.prefetch0 = 37760,
			.prefetch1 = 15181,
			.ram = subxl_initial_ram_24,
			.ram_len = 6,
		},
		.final = {
			.regs = {
				1912792442, 2014470875, 190922587, 2322231910, 4005525452, 1537634926, 3830746880, 1298310455, 724739979, 483854543, 3485735879, 2677682084, 3698513350, 1918455832, 2348599577, 14188284, 8031770, 8194, 7455970
			},
			.prefetch0 = 15181,
			.prefetch1 = 9800,
			.ram = subxl_final_ram_24,
			.ram_len = 6,
		},
		.transactions = subxl_transactions_24,
		.transactions_len = 2,
		.lenght = 8,
	},
	{
		.name = "025 SUBX.l -(A3), -(A1) 938b",
		.initial = {
			.regs = {
				3570376638, 2548890199, 1174558936, 449805264, 1962253541, 4164646651, 396280269, 3653163903, 619914341, 3895019548, 821034241, 299342175, 951991860, 2538742506, 1994309922, 5407260, 13433220, 8719, 16168430
			},
			.prefetch0 = 37771,
			.prefetch1 = 61339,
			.ram = subxl_initial_ram_25,
			.ram_len = 12,
		},
		.final = {
			.regs = {
				3570376638, 2548890199, 1174558936, 449805264, 1962253541, 4164646651, 396280269, 3653163903, 619914341, 3895019548, 821034241, 299342175, 951991860, 2538742506, 1994309922, 5407260, 13433206, 8719, 4181863644
			},
			.prefetch0 = 4685,
			.prefetch1 = 56053,
			.ram = subxl_final_ram_25,
			.ram_len = 26,
		},
		.transactions = subxl_transactions_25,
		.transactions_len = 15,
		.lenght = 60,
	},
	{
		.name = "026 SUBX.l D0, D4 9980",
		.initial = {
			.regs = {
				3075472069, 3743004784, 1327931976, 3189873874, 2680825569, 4224670368, 3850142375, 2595611811, 322082976, 3336155797, 3319912808, 209611322, 398807428, 2402646334, 3768753883, 9307776, 15412560, 42515, 14070576
			},
			.prefetch0 = 39296,
			.prefetch1 = 17330,
			.ram = subxl_initial_ram_26,
			.ram_len = 6,
		},
		.final = {
			.regs = {
				3075472069, 3743004784, 1327931976, 3189873874, 3900320795, 4224670368, 3850142375, 2595611811, 322082976, 3336155797, 3319912808, 209611322, 398807428, 2402646334, 3768753883, 9307776, 15412560, 42521, 14070578
			},
			.prefetch0 = 17330,
			.prefetch1 = 63761,
			.ram = subxl_final_ram_26,
			.ram_len = 6,
		},
		.transactions = subxl_transactions_26,
		.transactions_len = 2,
		.lenght = 8,
	},
	{
		.name = "027 SUBX.l D7, D3 9787",
		.initial = {
			.regs = {
				1184007354, 3795267327, 198913356, 1007846638, 1747882830, 996806183, 1284005979, 1782052525, 80925833, 1580039715, 2368958802, 3287532142, 1296364286, 3225898708, 3190261959, 4632712, 11790102, 33298, 10469502
			},
			.prefetch0 = 38791,
			.prefetch1 = 48307,
			.ram = subxl_initial_ram_27,
			.ram_len = 6,
		},
		.final = {
			.regs = {
				1184007354, 3795267327, 198913356, 3520761408, 1747882830, 996806183, 1284005979, 1782052525, 80925833, 1580039715, 2368958802, 3287532142, 1296364286, 3225898708, 3190261959, 4632712, 11790102, 33305, 10469504
			},
			.prefetch0 = 48307,
			.prefetch1 = 41318,
			.ram = subxl_final_ram_27,
			.ram_len = 6,
		},
		.transactions = subxl_transactions_27,
		.transactions_len = 2,
		.lenght = 8,
	},
	{
		.name = "028 SUBX.l -(A5), -(A6) 9d8d",
		.initial = {
			.regs = {
				4071938213, 409287145, 1934624073, 2627202865, 3784244373, 3837128060, 3238382061, 269194930, 3124239619, 2886771747, 125012110, 2110159079, 751045534, 637959326, 1835666805, 8528606, 109124, 8205, 5508416
			},
			.prefetch0 = 40333,
			.prefetch1 = 63598,
			.ram = subxl_initial_ram_28,
			.ram_len = 16,
		},
		.final = {
			.regs = {
				4071938213, 409287145, 1934624073, 2627202865, 3784244373, 3837128060, 3238382061, 269194930, 3124239619, 2886771747, 125012110, 2110159079, 751045534, 637959322, 1835666805, 8528606, 109110, 8205, 2720010588
			},
			.prefetch0 = 58644,
			.prefetch1 = 58574,
			.ram = subxl_final_ram_28,
			.ram_len = 30,
		},
		.transactions = subxl_transactions_28,
		.transactions_len = 17,
		.lenght = 68,
	},
	{
		.name = "029 SUBX.l -(A4), -(A4) 998c",
		.initial = {
			.regs = {
				4232444812, 382637019, 735605239, 2493153620, 236700797, 361141097, 171186720, 4101643752, 822376654, 575128201, 134772874, 2654007213, 3862264437, 2028131233, 462448339, 16592582, 6838198, 1033, 11469926
			},
			.prefetch0 = 39308,
			.prefetch1 = 31521,
			.ram = subxl_initial_ram_29,
			.ram_len = 12,
		},
		.final = {
			.regs = {
				4232444812, 382637019, 735605239, 2493153620, 236700797, 361141097, 171186720, 4101643752, 822376654, 575128201, 134772874, 2654007213, 3862264437, 2028131233, 462448339, 16592582, 6838184, 9225, 2812864018
			},
			.prefetch0 = 49296,
			.prefetch1 = 47200,
			.ram = subxl_final_ram_29,
			.ram_len = 26,
		},
		.transactions = subxl_transactions_29,
		.transactions_len = 15,
		.lenght = 60,
	},
	{
		.name = "030 SUBX.l D0, D0 9180",
		.initial = {
			.regs = {
				2758195523, 4170241024, 4160476145, 1175109244, 3316075705, 578222747, 1820258780, 2038952778, 3705049449, 3220947236, 1602370028, 1470433944, 2892506305, 956299063, 3483439099, 11413104, 3035638, 9477, 2891714
			},
			.prefetch0 = 37248,
			.prefetch1 = 13552,
			.ram = subxl_initial_ram_30,
			.ram_len = 6,
		},
		.final = {
			.regs = {
				0, 4170241024, 4160476145, 1175109244, 3316075705, 578222747, 1820258780, 2038952778, 3705049449, 3220947236, 1602370028, 1470433944, 2892506305, 956299063, 3483439099, 11413104, 3035638, 9476, 2891716
			},
			.prefetch0 = 13552,
			.prefetch1 = 54587,
			.ram = subxl_final_ram_30,
			.ram_len = 6,
		},
		.transactions = subxl_transactions_30,
		.transactions_len = 2,
		.lenght = 8,
	},
	{
		.name = "031 SUBX.l D7, D1 9387",
		.initial = {
			.regs = {
				317871068, 1641936707, 1296260683, 435413932, 1922834919, 957535211, 1799463400, 1739472637, 49298181, 2743736356, 3941009272, 104656812, 1841908630, 4094173303, 104993762, 5822608, 12125560, 33284, 16428554
			},
			.prefetch0 = 37767,
			.prefetch1 = 37946,
			.ram = subxl_initial_ram_31,
			.ram_len = 6,
		},
		.final = {
			.regs = {
				317871068, 4197431366, 1296260683, 435413932, 1922834919, 957535211, 1799463400, 1739472637, 49298181, 2743736356, 3941009272, 104656812, 1841908630, 4094173303, 104993762, 5822608, 12125560, 33305, 16428556
			},
			.prefetch0 = 37946,
			.prefetch1 = 47366,
			.ram = subxl_final_ram_31,
			.ram_len = 6,
		},
		.transactions = subxl_transactions_31,
		.transactions_len = 2,
		.lenght = 8,
	},
};
