...
static const SST_RamByte rts_initial_ram_16[] = {
		{ .addr = 0x37c362, .byte = 0x4e },
		{ .addr = 0x37c363, .byte = 0x75 },
		{ .addr = 0x37c364, .byte = 0x82 },
		{ .addr = 0x37c365, .byte = 0xa7 },
		{ .addr = 0x7b6082, .byte = 0x69 },
		{ .addr = 0x7b6083, .byte = 0xc9 },
		{ .addr = 0x7b6084, .byte = 0x37 },
		{ .addr = 0x7b6085, .byte = 0xe4 },
		{ .addr = 0xc937e4, .byte = 0xb6 },
		{ .addr = 0xc937e5, .byte = 0x89 },
		{ .addr = 0xc937e6, .byte = 0xf1 },
		{ .addr = 0xc937e7, .byte = 0xfd }
};

static const SST_RamByte rts_final_ram_16[] = {
		{ .addr = 0x37c362, .byte = 0x4e },
		{ .addr = 0x37c363, .byte = 0x75 },
		{ .addr = 0x37c364, .byte = 0x82 },
		{ .addr = 0x37c365, .byte = 0xa7 },
...
static const SST_Transaction rts_transactions_16[] = {
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 1, .addr = 8085634, .data = 27081, .uds = true, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 1, .addr = 8085636, .data = 14308, .uds = true, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 2, .addr = 13187044, .data = 46729, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 2, .addr = 13187046, .data = 61949, .uds = false, .lds = false, .is_word = false, 
		}
	},
};

static const SST_RamByte rts_initial_ram_17[] = {
		{ .addr = 0x9cee7e, .byte = 0x4e },
		{ .addr = 0x9cee7f, .byte = 0x75 },
		{ .addr = 0x9cee80, .byte = 0xcc },
		{ .addr = 0x9cee81, .byte = 0x94 },
		{ .addr = 0x1ae0fa, .byte = 0x62 },
		{ .addr = 0x1ae0fb, .byte = 0x63 },
		{ .addr = 0x1ae0fc, .byte = 0x37 },
		{ .addr = 0x1ae0fd, .byte = 0x36 },
		{ .addr = 0x633736, .byte = 0x32 },
		{ .addr = 0x633737, .byte = 0x55 },
		{ .addr = 0x633738, .byte = 0xe8 },
		{ .addr = 0x633739, .byte = 0xf7 }
};

static const SST_RamByte rts_final_ram_17[] = {
		{ .addr = 0x9cee7e, .byte = 0x4e },
		{ .addr = 0x9cee7f, .byte = 0x75 },
		{ .addr = 0x9cee80, .byte = 0xcc },
		{ .addr = 0x9cee81, .byte = 0x94 },
...
static const SST_Transaction rts_transactions_17[] = {
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 1, .addr = 1761530, .data = 25187, .uds = true, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 1, .addr = 1761532, .data = 14134, .uds = true, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 2, .addr = 6502198, .data = 12885, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 2, .addr = 6502200, .data = 59639, .uds = false, .lds = false, .is_word = false, 
		}
	},
};

static const SST_RamByte rts_initial_ram_18[] = {
		{ .addr = 0xf6ba76, .byte = 0x4e },
		{ .addr = 0xf6ba77, .byte = 0x75 },
		{ .addr = 0xf6ba78, .byte = 0x4d },
		{ .addr = 0xf6ba79, .byte = 0x6a },
		{ .addr = 0x2b0bea, .byte = 0x0b },
		{ .addr = 0x2b0beb, .byte = 0xf2 },
		{ .addr = 0x2b0bec, .byte = 0xb6 },
		{ .addr = 0x2b0bed, .byte = 0xf2 },
		{ .addr = 0xf2b6f2, .byte = 0x38 },
		{ .addr = 0xf2b6f3, .byte = 0x69 },
		{ .addr = 0xf2b6f4, .byte = 0xcc },
		{ .addr = 0xf2b6f5, .byte = 0x60 }
};

static const SST_RamByte rts_final_ram_18[] = {
		{ .addr = 0xf6ba76, .byte = 0x4e },
		{ .addr = 0xf6ba77, .byte = 0x75 },
		{ .addr = 0xf6ba78, .byte = 0x4d },
		{ .addr = 0xf6ba79, .byte = 0x6a },
...
static const SST_Transaction rts_transactions_18[] = {
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 2821098, .data = 3058, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 2821100, .data = 46834, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 15906546, .data = 14441, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 15906548, .data = 52320, .uds = false, .lds = false, .is_word = false, 
		}
	},
};

static const SST_RamByte rts_initial_ram_19[] = {
		{ .addr = 0xa590ce, .byte = 0x4e },
		{ .addr = 0xa590cf, .byte = 0x75 },
		{ .addr = 0xa590d0, .byte = 0x40 },
		{ .addr = 0xa590d1, .byte = 0x99 },
		{ .addr = 0x127b50, .byte = 0x3a },
		{ .addr = 0x127b51, .byte = 0x24 },
		{ .addr = 0x127b52, .byte = 0xe4 },
		{ .addr = 0x127b53, .byte = 0x17 },
		{ .addr = 0x00000c, .byte = 0xd0 },
		{ .addr = 0x00000d, .byte = 0xc6 },
		{ .addr = 0x00000e, .byte = 0x6a },
		{ .addr = 0x00000f, .byte = 0x16 },
		{ .addr = 0xc66a16, .byte = 0x56 },
		{ .addr = 0xc66a17, .byte = 0xc7 },
		{ .addr = 0xc66a18, .byte = 0xac },
		{ .addr = 0xc66a19, .byte = 0x6b }
};

static const SST_RamByte rts_final_ram_19[] = {
		{ .addr = 0xa590ce, .byte = 0x4e },
		{ .addr = 0xa590cf, .byte = 0x75 },
		{ .addr = 0xa590d0, .byte = 0x40 },
		{ .addr = 0xa590d1, .byte = 0x99 },
		...
		{ .addr = 0x127b52, .byte = 0xe4 },
		{ .addr = 0x127b53, .byte = 0x17 },
		{ .addr = 0xd0f9a4, .byte = 0x90 },
		{ .addr = 0xd0f9a5, .byte = 0xd0 },
		{ .addr = 0xd0f9a0, .byte = 0x86 },
		{ .addr = 0xd0f9a1, .byte = 0x15 },
		{ .addr = 0xd0f9a2, .byte = 0x00 },
		{ .addr = 0xd0f9a3, .byte = 0xa5 },
		{ .addr = 0xd0f99e, .byte = 0x4e },
		{ .addr = 0xd0f99f, .byte = 0x75 },
		{ .addr = 0xd0f99c, .byte = 0xe4 },
		{ .addr = 0xd0f99d, .byte = 0x17 },
		{ .addr = 0xd0f998, .byte = 0x4e },
		{ .addr = 0xd0f999, .byte = 0x72 },
		{ .addr = 0xd0f99a, .byte = 0x3a },
		{ .addr = 0xd0f99b, .byte = 0x24 },
		{ .addr = 0x00000c, .byte = 0xd0 },
		{ .addr = 0x00000d, .byte = 0xc6 },
		{ .addr = 0x00000e, .byte = 0x6a },
		{ .addr = 0x00000f, .byte = 0x16 },
...
static const SST_Transaction rts_transactions_19[] = {
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 1, .addr = 1211216, .data = 14884, .uds = true, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 1, .addr = 1211218, .data = 58391, .uds = true, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_RE,
		.cycles = 4,
		.bus = {
			.fc = 2, .addr = 2417686, .data = 20058, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 8 },
	{
		...
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 13695396, .data = 37072, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 13695392, .data = 34325, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 13695394, .data = 165, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 13695390, .data = 20085, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 13695388, .data = 58391, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 13695384, .data = 20082, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 13695386, .data = 14884, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 12, .data = 53446, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 14, .data = 27158, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 13003286, .data = 22215, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 2 },
	{
		...
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 13003288, .data = 44139, .uds = false, .lds = false, .is_word = false, 
		}
	},
};

static const SST_RamByte rts_initial_ram_20[] = {
		{ .addr = 0x308246, .byte = 0x4e },
		{ .addr = 0x308247, .byte = 0x75 },
		{ .addr = 0x308248, .byte = 0x83 },
		{ .addr = 0x308249, .byte = 0xa9 },
		{ .addr = 0x1414dc, .byte = 0x9b },
		{ .addr = 0x1414dd, .byte = 0x5a },
		{ .addr = 0x1414de, .byte = 0x4b },
		{ .addr = 0x1414df, .byte = 0xe6 },
		{ .addr = 0x5a4be6, .byte = 0xf9 },
		{ .addr = 0x5a4be7, .byte = 0x5a },
		{ .addr = 0x5a4be8, .byte = 0x52 },
		{ .addr = 0x5a4be9, .byte = 0x4a }
};

static const SST_RamByte rts_final_ram_20[] = {
		{ .addr = 0x308246, .byte = 0x4e },
		{ .addr = 0x308247, .byte = 0x75 },
		{ .addr = 0x308248, .byte = 0x83 },
		{ .addr = 0x308249, .byte = 0xa9 },
...
static const SST_Transaction rts_transactions_20[] = {
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 1, .addr = 1316060, .data = 39770, .uds = true, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 1, .addr = 1316062, .data = 19430, .uds = true, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 2, .addr = 5917670, .data = 63834, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 2, .addr = 5917672, .data = 21066, .uds = false, .lds = false, .is_word = false, 
		}
	},
};

static const SST_RamByte rts_initial_ram_21[] = {
		{ .addr = 0x2aeb56, .byte = 0x4e },
		{ .addr = 0x2aeb57, .byte = 0x75 },
		{ .addr = 0x2aeb58, .byte = 0x12 },
		{ .addr = 0x2aeb59, .byte = 0xf8 },
		{ .addr = 0x72b92a, .byte = 0x32 },
		{ .addr = 0x72b92b, .byte = 0xa9 },
		{ .addr = 0x72b92c, .byte = 0xd8 },
		{ .addr = 0x72b92d, .byte = 0x61 },
		{ .addr = 0x00000c, .byte = 0xde },
		{ .addr = 0x00000d, .byte = 0x70 },
		{ .addr = 0x00000e, .byte = 0x51 },
		{ .addr = 0x00000f, .byte = 0x48 },
		{ .addr = 0x705148, .byte = 0x2c },
		{ .addr = 0x705149, .byte = 0x62 },
		{ .addr = 0x70514a, .byte = 0xd7 },
		{ .addr = 0x70514b, .byte = 0x26 }
};

static const SST_RamByte rts_final_ram_21[] = {
		{ .addr = 0x2aeb56, .byte = 0x4e },
		{ .addr = 0x2aeb57, .byte = 0x75 },
		{ .addr = 0x2aeb58, .byte = 0x12 },
		{ .addr = 0x2aeb59, .byte = 0xf8 },
		...
		{ .addr = 0x72b92c, .byte = 0xd8 },
		{ .addr = 0x72b92d, .byte = 0x61 },
		{ .addr = 0x55d65a, .byte = 0xeb },
		{ .addr = 0x55d65b, .byte = 0x58 },
		{ .addr = 0x55d656, .byte = 0x07 },
		{ .addr = 0x55d657, .byte = 0x10 },
		{ .addr = 0x55d658, .byte = 0x00 },
		{ .addr = 0x55d659, .byte = 0x2a },
		{ .addr = 0x55d654, .byte = 0x4e },
		{ .addr = 0x55d655, .byte = 0x75 },
		{ .addr = 0x55d652, .byte = 0xd8 },
		{ .addr = 0x55d653, .byte = 0x61 },
		{ .addr = 0x55d64e, .byte = 0x4e },
		{ .addr = 0x55d64f, .byte = 0x72 },
		{ .addr = 0x55d650, .byte = 0x32 },
		{ .addr = 0x55d651, .byte = 0xa9 },
		{ .addr = 0x00000c, .byte = 0xde },
		{ .addr = 0x00000d, .byte = 0x70 },
		{ .addr = 0x00000e, .byte = 0x51 },
		{ .addr = 0x00000f, .byte = 0x48 },
...
static const SST_Transaction rts_transactions_21[] = {
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 1, .addr = 7518506, .data = 12969, .uds = true, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 1, .addr = 7518508, .data = 55393, .uds = true, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_RE,
		.cycles = 4,
		.bus = {
			.fc = 2, .addr = 11130976, .data = 5446, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 8 },
	{
		...
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 5625434, .data = 60248, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 5625430, .data = 1808, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 5625432, .data = 42, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 5625428, .data = 20085, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 5625426, .data = 55393, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 5625422, .data = 20082, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 5625424, .data = 12969, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 12, .data = 56944, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 14, .data = 20808, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 7360840, .data = 11362, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 2 },
	{
		...
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 7360842, .data = 55078, .uds = false, .lds = false, .is_word = false, 
		}
	},
};

static const SST_RamByte rts_initial_ram_22[] = {
		{ .addr = 0x7ee88a, .byte = 0x4e },
		{ .addr = 0x7ee88b, .byte = 0x75 },
		{ .addr = 0x7ee88c, .byte = 0x27 },
		{ .addr = 0x7ee88d, .byte = 0x99 },
		{ .addr = 0xc0d57e, .byte = 0x68 },
		{ .addr = 0xc0d57f, .byte = 0x29 },
		{ .addr = 0xc0d580, .byte = 0x9c },
		{ .addr = 0xc0d581, .byte = 0xcd },
		{ .addr = 0x00000c, .byte = 0xd5 },
		{ .addr = 0x00000d, .byte = 0x00 },
		{ .addr = 0x00000e, .byte = 0x18 },
		{ .addr = 0x00000f, .byte = 0x78 },
		{ .addr = 0x001878, .byte = 0xd4 },
		{ .addr = 0x001879, .byte = 0xa1 },
		{ .addr = 0x00187a, .byte = 0xa0 },
		{ .addr = 0x00187b, .byte = 0xd4 }
};

static const SST_RamByte rts_final_ram_22[] = {
		{ .addr = 0x7ee88a, .byte = 0x4e },
		{ .addr = 0x7ee88b, .byte = 0x75 },
		{ .addr = 0x7ee88c, .byte = 0x27 },
		{ .addr = 0x7ee88d, .byte = 0x99 },
		...
		{ .addr = 0xc0d580, .byte = 0x9c },
		{ .addr = 0xc0d581, .byte = 0xcd },
		{ .addr = 0x157178, .byte = 0xe8 },
		{ .addr = 0x157179, .byte = 0x8c },
		{ .addr = 0x157174, .byte = 0x06 },
		{ .addr = 0x157175, .byte = 0x0d },
		{ .addr = 0x157176, .byte = 0x00 },
		{ .addr = 0x157177, .byte = 0x7e },
		{ .addr = 0x157172, .byte = 0x4e },
		{ .addr = 0x157173, .byte = 0x75 },
		{ .addr = 0x157170, .byte = 0x9c },
		{ .addr = 0x157171, .byte = 0xcd },
		{ .addr = 0x15716c, .byte = 0x4e },
		{ .addr = 0x15716d, .byte = 0x72 },
		{ .addr = 0x15716e, .byte = 0x68 },
		{ .addr = 0x15716f, .byte = 0x29 },
		{ .addr = 0x00000c, .byte = 0xd5 },
		{ .addr = 0x00000d, .byte = 0x00 },
		{ .addr = 0x00000e, .byte = 0x18 },
		{ .addr = 0x00000f, .byte = 0x78 },
...
static const SST_Transaction rts_transactions_22[] = {
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 1, .addr = 12637566, .data = 26665, .uds = true, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 1, .addr = 12637568, .data = 40141, .uds = true, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_RE,
		.cycles = 4,
		.bus = {
			.fc = 2, .addr = 2727116, .data = 11006, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 8 },
	{
		...
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 1405304, .data = 59532, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 1405300, .data = 1549, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 1405302, .data = 126, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 1405298, .data = 20085, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 1405296, .data = 40141, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 1405292, .data = 20082, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 1405294, .data = 26665, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 12, .data = 54528, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 14, .data = 6264, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 6264, .data = 54433, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 2 },
	{
		...
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 6266, .data = 41172, .uds = false, .lds = false, .is_word = false, 
		}
	},
};

static const SST_RamByte rts_initial_ram_23[] = {
		{ .addr = 0xbe879a, .byte = 0x4e },
		{ .addr = 0xbe879b, .byte = 0x75 },
		{ .addr = 0xbe879c, .byte = 0x35 },
		{ .addr = 0xbe879d, .byte = 0x40 },
		{ .addr = 0x46cbb0, .byte = 0xd7 },
		{ .addr = 0x46cbb1, .byte = 0xe1 },
		{ .addr = 0x46cbb2, .byte = 0x18 },
		{ .addr = 0x46cbb3, .byte = 0xc7 },
		{ .addr = 0x00000c, .byte = 0xa3 },
		{ .addr = 0x00000d, .byte = 0x4a },
		{ .addr = 0x00000e, .byte = 0x45 },
		{ .addr = 0x00000f, .byte = 0x1a },
		{ .addr = 0x4a451a, .byte = 0xe6 },
		{ .addr = 0x4a451b, .byte = 0x58 },
		{ .addr = 0x4a451c, .byte = 0xbb },
		{ .addr = 0x4a451d, .byte = 0x76 }
};

static const SST_RamByte rts_final_ram_23[] = {
		{ .addr = 0xbe879a, .byte = 0x4e },
		{ .addr = 0xbe879b, .byte = 0x75 },
		{ .addr = 0xbe879c, .byte = 0x35 },
		{ .addr = 0xbe879d, .byte = 0x40 },
		...
		{ .addr = 0x46cbb2, .byte = 0x18 },
		{ .addr = 0x46cbb3, .byte = 0xc7 },
		{ .addr = 0x093518, .byte = 0x87 },
		{ .addr = 0x093519, .byte = 0x9c },
		{ .addr = 0x093514, .byte = 0x85 },
		{ .addr = 0x093515, .byte = 0x00 },
		{ .addr = 0x093516, .byte = 0x00 },
		{ .addr = 0x093517, .byte = 0xbe },
		{ .addr = 0x093512, .byte = 0x4e },
		{ .addr = 0x093513, .byte = 0x75 },
		{ .addr = 0x093510, .byte = 0x18 },
		{ .addr = 0x093511, .byte = 0xc7 },
		{ .addr = 0x09350c, .byte = 0x4e },
		{ .addr = 0x09350d, .byte = 0x72 },
		{ .addr = 0x09350e, .byte = 0xd7 },
		{ .addr = 0x09350f, .byte = 0xe1 },
		{ .addr = 0x00000c, .byte = 0xa3 },
		{ .addr = 0x00000d, .byte = 0x4a },
		{ .addr = 0x00000e, .byte = 0x45 },
		{ .addr = 0x00000f, .byte = 0x1a },
...
static const SST_Transaction rts_transactions_23[] = {
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 1, .addr = 4639664, .data = 55265, .uds = true, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 1, .addr = 4639666, .data = 6343, .uds = true, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_RE,
		.cycles = 4,
		.bus = {
			.fc = 2, .addr = 14751942, .data = 7422, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 8 },
	{
		...
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 603416, .data = 34716, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 603412, .data = 34048, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 603414, .data = 190, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 603410, .data = 20085, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 603408, .data = 6343, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 603404, .data = 20082, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 603406, .data = 55265, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 12, .data = 41802, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 14, .data = 17690, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 4867354, .data = 58968, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 2 },
	{
		...
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 4867356, .data = 47990, .uds = false, .lds = false, .is_word = false, 
		}
	},
};

static const SST_RamByte rts_initial_ram_24[] = {
		{ .addr = 0x60b212, .byte = 0x4e },
		{ .addr = 0x60b213, .byte = 0x75 },
		{ .addr = 0x60b214, .byte = 0x3f },
		{ .addr = 0x60b215, .byte = 0xf0 },
		{ .addr = 0x0ff0fe, .byte = 0x3b },
		{ .addr = 0x0ff0ff, .byte = 0xf9 },
		{ .addr = 0x0ff100, .byte = 0x03 },
		{ .addr = 0x0ff101, .byte = 0x72 },
		{ .addr = 0xf90372, .byte = 0xda },
		{ .addr = 0xf90373, .byte = 0xfa },
		{ .addr = 0xf90374, .byte = 0x31 },
		{ .addr = 0xf90375, .byte = 0xc7 }
};

static const SST_RamByte rts_final_ram_24[] = {
		{ .addr = 0x60b212, .byte = 0x4e },
		{ .addr = 0x60b213, .byte = 0x75 },
		{ .addr = 0x60b214, .byte = 0x3f },
		{ .addr = 0x60b215, .byte = 0xf0 },
...
static const SST_Transaction rts_transactions_24[] = {
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 1, .addr = 1044734, .data = 15353, .uds = true, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 1, .addr = 1044736, .data = 882, .uds = true, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 2, .addr = 16319346, .data = 56058, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 2, .addr = 16319348, .data = 12743, .uds = false, .lds = false, .is_word = false, 
		}
	},
};

static const SST_RamByte rts_initial_ram_25[] = {
		{ .addr = 0x0af38e, .byte = 0x4e },
		{ .addr = 0x0af38f, .byte = 0x75 },
		{ .addr = 0x0af390, .byte = 0x0e },
		{ .addr = 0x0af391, .byte = 0x27 },
		{ .addr = 0x8400f0, .byte = 0x4a },
		{ .addr = 0x8400f1, .byte = 0x09 },
		{ .addr = 0x8400f2, .byte = 0xa7 },
		{ .addr = 0x8400f3, .byte = 0x7d },
		{ .addr = 0x00000c, .byte = 0x5a },
		{ .addr = 0x00000d, .byte = 0x00 },
		{ .addr = 0x00000e, .byte = 0xb9 },
		{ .addr = 0x00000f, .byte = 0x36 },
		{ .addr = 0x00b936, .byte = 0x41 },
		{ .addr = 0x00b937, .byte = 0xa9 },
		{ .addr = 0x00b938, .byte = 0x0e },
		{ .addr = 0x00b939, .byte = 0xa1 }
};

static const SST_RamByte rts_final_ram_25[] = {
		{ .addr = 0x0af38e, .byte = 0x4e },
		{ .addr = 0x0af38f, .byte = 0x75 },
		{ .addr = 0x0af390, .byte = 0x0e },
		{ .addr = 0x0af391, .byte = 0x27 },
		...
		{ .addr = 0x8400f2, .byte = 0xa7 },
		{ .addr = 0x8400f3, .byte = 0x7d },
		{ .addr = 0xb1f4c6, .byte = 0xf3 },
		{ .addr = 0xb1f4c7, .byte = 0x90 },
		{ .addr = 0xb1f4c2, .byte = 0x06 },
		{ .addr = 0xb1f4c3, .byte = 0x0b },
		{ .addr = 0xb1f4c4, .byte = 0x00 },
		{ .addr = 0xb1f4c5, .byte = 0x0a },
		{ .addr = 0xb1f4c0, .byte = 0x4e },
		{ .addr = 0xb1f4c1, .byte = 0x75 },
		{ .addr = 0xb1f4be, .byte = 0xa7 },
		{ .addr = 0xb1f4bf, .byte = 0x7d },
		{ .addr = 0xb1f4ba, .byte = 0x4e },
		{ .addr = 0xb1f4bb, .byte = 0x72 },
		{ .addr = 0xb1f4bc, .byte = 0x4a },
		{ .addr = 0xb1f4bd, .byte = 0x09 },
		{ .addr = 0x00000c, .byte = 0x5a },
		{ .addr = 0x00000d, .byte = 0x00 },
		{ .addr = 0x00000e, .byte = 0xb9 },
		{ .addr = 0x00000f, .byte = 0x36 },
...
static const SST_Transaction rts_transactions_25[] = {
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 1, .addr = 8650992, .data = 18953, .uds = true, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 1, .addr = 8650994, .data = 42877, .uds = true, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_RE,
		.cycles = 4,
		.bus = {
			.fc = 2, .addr = 632700, .data = 55201, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 8 },
	{
		...
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 11662534, .data = 62352, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 11662530, .data = 1547, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 11662532, .data = 10, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 11662528, .data = 20085, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 11662526, .data = 42877, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 11662522, .data = 20082, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 11662524, .data = 18953, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 12, .data = 23040, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 14, .data = 47414, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 47414, .data = 16809, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 2 },
	{
		...
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 47416, .data = 3745, .uds = false, .lds = false, .is_word = false, 
		}
	},
};

static const SST_RamByte rts_initial_ram_26[] = {
		{ .addr = 0xa5253e, .byte = 0x4e },
		{ .addr = 0xa5253f, .byte = 0x75 },
		{ .addr = 0xa52540, .byte = 0x13 },
		{ .addr = 0xa52541, .byte = 0x15 },
		{ .addr = 0xf4d74a, .byte = 0xe5 },
		{ .addr = 0xf4d74b, .byte = 0xdd },
		{ .addr = 0xf4d74c, .byte = 0xd5 },
		{ .addr = 0xf4d74d, .byte = 0x02 },
		{ .addr = 0xddd502, .byte = 0x60 },
		{ .addr = 0xddd503, .byte = 0x0e },
		{ .addr = 0xddd504, .byte = 0x27 },
		{ .addr = 0xddd505, .byte = 0x70 }
};

static const SST_RamByte rts_final_ram_26[] = {
		{ .addr = 0xa5253e, .byte = 0x4e },
		{ .addr = 0xa5253f, .byte = 0x75 },
		{ .addr = 0xa52540, .byte = 0x13 },
		{ .addr = 0xa52541, .byte = 0x15 },
...
static const SST_Transaction rts_transactions_26[] = {
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 1, .addr = 16045898, .data = 58845, .uds = true, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 1, .addr = 16045900, .data = 54530, .uds = true, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 2, .addr = 14537986, .data = 24590, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 2, .addr = 14537988, .data = 10096, .uds = false, .lds = false, .is_word = false, 
		}
	},
};

static const SST_RamByte rts_initial_ram_27[] = {
		{ .addr = 0x67a8ae, .byte = 0x4e },
		{ .addr = 0x67a8af, .byte = 0x75 },
		{ .addr = 0x67a8b0, .byte = 0x94 },
		{ .addr = 0x67a8b1, .byte = 0xb4 },
		{ .addr = 0xb223d8, .byte = 0x1d },
		{ .addr = 0xb223d9, .byte = 0xc6 },
		{ .addr = 0xb223da, .byte = 0x97 },
		{ .addr = 0xb223db, .byte = 0xd1 },
		{ .addr = 0x00000c, .byte = 0x73 },
		{ .addr = 0x00000d, .byte = 0x32 },
		{ .addr = 0x00000e, .byte = 0x5c },
		{ .addr = 0x00000f, .byte = 0x3a },
		{ .addr = 0x325c3a, .byte = 0xcf },
		{ .addr = 0x325c3b, .byte = 0xf7 },
		{ .addr = 0x325c3c, .byte = 0xf7 },
		{ .addr = 0x325c3d, .byte = 0x39 }
};

static const SST_RamByte rts_final_ram_27[] = {
		{ .addr = 0x67a8ae, .byte = 0x4e },
		{ .addr = 0x67a8af, .byte = 0x75 },
		{ .addr = 0x67a8b0, .byte = 0x94 },
		{ .addr = 0x67a8b1, .byte = 0xb4 },
		{ .addr = 0xb223d8, .byte = 0x00 },
		{ .addr = 0xb223d9, .byte = 0x67 },
		{ .addr = 0xb223da, .byte = 0xa8 },
		{ .addr = 0xb223db, .byte = 0xb0 },
		{ .addr = 0xb223d6, .byte = 0x24 },
		{ .addr = 0xb223d7, .byte = 0x0e },
		{ .addr = 0xb223d4, .byte = 0x4e },
		{ .addr = 0xb223d5, .byte = 0x75 },
		{ .addr = 0xb223d2, .byte = 0x97 },
		{ .addr = 0xb223d3, .byte = 0xd1 },
		{ .addr = 0xb223ce, .byte = 0x4e },
		{ .addr = 0xb223cf, .byte = 0x76 },
		{ .addr = 0xb223d0, .byte = 0x1d },
		{ .addr = 0xb223d1, .byte = 0xc6 },
		{ .addr = 0x00000c, .byte = 0x73 },
		{ .addr = 0x00000d, .byte = 0x32 },
		{ .addr = 0x00000e, .byte = 0x5c },
		{ .addr = 0x00000f, .byte = 0x3a },
...
static const SST_Transaction rts_transactions_27[] = {
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 11674584, .data = 7622, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 11674586, .data = 38865, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_RE,
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 13014992, .data = 35920, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 8 },
	{
		...
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 11674586, .data = 43184, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 11674582, .data = 9230, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 11674584, .data = 103, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 11674580, .data = 20085, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 11674578, .data = 38865, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 11674574, .data = 20086, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 11674576, .data = 7622, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 12, .data = 29490, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 14, .data = 23610, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 3300410, .data = 53239, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 2 },
	{
		...
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 3300412, .data = 63289, .uds = false, .lds = false, .is_word = false, 
		}
	},
};

static const SST_RamByte rts_initial_ram_28[] = {
		{ .addr = 0xf90942, .byte = 0x4e },
		{ .addr = 0xf90943, .byte = 0x75 },
		{ .addr = 0xf90944, .byte = 0x77 },
		{ .addr = 0xf90945, .byte = 0x6e },
		{ .addr = 0x54f774, .byte = 0x52 },
		{ .addr = 0x54f775, .byte = 0x68 },
		{ .addr = 0x54f776, .byte = 0xf3 },
		{ .addr = 0x54f777, .byte = 0x3b },
		{ .addr = 0x00000c, .byte = 0x36 },
		{ .addr = 0x00000d, .byte = 0xbe },
		{ .addr = 0x00000e, .byte = 0x8a },
		{ .addr = 0x00000f, .byte = 0x3e },
		{ .addr = 0xbe8a3e, .byte = 0xc7 },
		{ .addr = 0xbe8a3f, .byte = 0xcd },
		{ .addr = 0xbe8a40, .byte = 0x80 },
		{ .addr = 0xbe8a41, .byte = 0xb1 }
};

static const SST_RamByte rts_final_ram_28[] = {
		{ .addr = 0xf90942, .byte = 0x4e },
		{ .addr = 0xf90943, .byte = 0x75 },
		{ .addr = 0xf90944, .byte = 0x77 },
		{ .addr = 0xf90945, .byte = 0x6e },
		{ .addr = 0x54f774, .byte = 0x00 },
		{ .addr = 0x54f775, .byte = 0xf9 },
		{ .addr = 0x54f776, .byte = 0x09 },
		{ .addr = 0x54f777, .byte = 0x44 },
		{ .addr = 0x54f772, .byte = 0x20 },
		{ .addr = 0x54f773, .byte = 0x04 },
		{ .addr = 0x54f770, .byte = 0x4e },
		{ .addr = 0x54f771, .byte = 0x75 },
		{ .addr = 0x54f76e, .byte = 0xf3 },
		{ .addr = 0x54f76f, .byte = 0x3b },
		{ .addr = 0x54f76a, .byte = 0x4e },
		{ .addr = 0x54f76b, .byte = 0x76 },
		{ .addr = 0x54f76c, .byte = 0x52 },
		{ .addr = 0x54f76d, .byte = 0x68 },
		{ .addr = 0x00000c, .byte = 0x36 },
		{ .addr = 0x00000d, .byte = 0xbe },
		{ .addr = 0x00000e, .byte = 0x8a },
		{ .addr = 0x00000f, .byte = 0x3e },
...
static const SST_Transaction rts_transactions_28[] = {
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 5568372, .data = 21096, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 5568374, .data = 62267, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_RE,
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 6878010, .data = 18512, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 8 },
	{
		...
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 5568374, .data = 2372, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 5568370, .data = 8196, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 5568372, .data = 249, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 5568368, .data = 20085, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 5568366, .data = 62267, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 5568362, .data = 20086, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 5568364, .data = 21096, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 12, .data = 14014, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 14, .data = 35390, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 12487230, .data = 51149, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 2 },
	{
		...
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 12487232, .data = 32945, .uds = false, .lds = false, .is_word = false, 
		}
	},
};

static const SST_RamByte rts_initial_ram_29[] = {
		{ .addr = 0x95b8f8, .byte = 0x4e },
		{ .addr = 0x95b8f9, .byte = 0x75 },
		{ .addr = 0x95b8fa, .byte = 0x4f },
		{ .addr = 0x95b8fb, .byte = 0x71 },
		{ .addr = 0x7a5a82, .byte = 0xc9 },
		{ .addr = 0x7a5a83, .byte = 0xed },
		{ .addr = 0x7a5a84, .byte = 0xed },
		{ .addr = 0x7a5a85, .byte = 0xcf },
		{ .addr = 0x00000c, .byte = 0x20 },
		{ .addr = 0x00000d, .byte = 0xce },
		{ .addr = 0x00000e, .byte = 0xd4 },
		{ .addr = 0x00000f, .byte = 0xaa },
		{ .addr = 0xced4aa, .byte = 0x4d },
		{ .addr = 0xced4ab, .byte = 0xa3 },
		{ .addr = 0xced4ac, .byte = 0xc2 },
		{ .addr = 0xced4ad, .byte = 0x15 }
};

static const SST_RamByte rts_final_ram_29[] = {
		{ .addr = 0x95b8f8, .byte = 0x4e },
		{ .addr = 0x95b8f9, .byte = 0x75 },
		{ .addr = 0x95b8fa, .byte = 0x4f },
		{ .addr = 0x95b8fb, .byte = 0x71 },
		...
		{ .addr = 0x7a5a84, .byte = 0xed },
		{ .addr = 0x7a5a85, .byte = 0xcf },
		{ .addr = 0xf0a960, .byte = 0xb8 },
		{ .addr = 0xf0a961, .byte = 0xfa },
		{ .addr = 0xf0a95c, .byte = 0x80 },
		{ .addr = 0xf0a95d, .byte = 0x00 },
		{ .addr = 0xf0a95e, .byte = 0x00 },
		{ .addr = 0xf0a95f, .byte = 0x95 },
		{ .addr = 0xf0a95a, .byte = 0x4e },
		{ .addr = 0xf0a95b, .byte = 0x75 },
		{ .addr = 0xf0a958, .byte = 0xed },
		{ .addr = 0xf0a959, .byte = 0xcf },
		{ .addr = 0xf0a954, .byte = 0x4e },
		{ .addr = 0xf0a955, .byte = 0x72 },
		{ .addr = 0xf0a956, .byte = 0xc9 },
		{ .addr = 0xf0a957, .byte = 0xed },
		{ .addr = 0x00000c, .byte = 0x20 },
		{ .addr = 0x00000d, .byte = 0xce },
		{ .addr = 0x00000e, .byte = 0xd4 },
		{ .addr = 0x00000f, .byte = 0xaa },
...
static const SST_Transaction rts_transactions_29[] = {
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 1, .addr = 8018562, .data = 51693, .uds = true, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 1, .addr = 8018564, .data = 60879, .uds = true, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_RE,
		.cycles = 4,
		.bus = {
			.fc = 2, .addr = 15592910, .data = 27672, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 8 },
	{
		...
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 15772000, .data = 47354, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 15771996, .data = 32768, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 15771998, .data = 149, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 15771994, .data = 20085, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 15771992, .data = 60879, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 15771988, .data = 20082, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 15771990, .data = 51693, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 12, .data = 8398, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 14, .data = 54442, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 13554858, .data = 19875, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 2 },
	{
		...
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 13554860, .data = 49685, .uds = false, .lds = false, .is_word = false, 
		}
	},
};

static const SST_RamByte rts_initial_ram_30[] = {
		{ .addr = 0xad0e68, .byte = 0x4e },
		{ .addr = 0xad0e69, .byte = 0x75 },
		{ .addr = 0xad0e6a, .byte = 0x1d },
		{ .addr = 0xad0e6b, .byte = 0xbe },
		{ .addr = 0x0510d4, .byte = 0xcb },
		{ .addr = 0x0510d5, .byte = 0x0e },
		{ .addr = 0x0510d6, .byte = 0x32 },
		{ .addr = 0x0510d7, .byte = 0x6c },
		{ .addr = 0x0e326c, .byte = 0x42 },
		{ .addr = 0x0e326d, .byte = 0x8b },
		{ .addr = 0x0e326e, .byte = 0x59 },
		{ .addr = 0x0e326f, .byte = 0x20 }
};

static const SST_RamByte rts_final_ram_30[] = {
		{ .addr = 0xad0e68, .byte = 0x4e },
		{ .addr = 0xad0e69, .byte = 0x75 },
		{ .addr = 0xad0e6a, .byte = 0x1d },
		{ .addr = 0xad0e6b, .byte = 0xbe },
...
static const SST_Transaction rts_transactions_30[] = {
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 1, .addr = 331988, .data = 51982, .uds = true, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 1, .addr = 331990, .data = 12908, .uds = true, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 2, .addr = 930412, .data = 17035, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 2, .addr = 930414, .data = 22816, .uds = false, .lds = false, .is_word = false, 
		}
	},
};

static const SST_RamByte rts_initial_ram_31[] = {
		{ .addr = 0xc5dfd4, .byte = 0x4e },
		{ .addr = 0xc5dfd5, .byte = 0x75 },
		{ .addr = 0xc5dfd6, .byte = 0x62 },
		{ .addr = 0xc5dfd7, .byte = 0x4e },
		{ .addr = 0x7f5adc, .byte = 0x94 },
		{ .addr = 0x7f5add, .byte = 0x0b },
		{ .addr = 0x7f5ade, .byte = 0x96 },
		{ .addr = 0x7f5adf, .byte = 0xf3 },
		{ .addr = 0x00000c, .byte = 0x7d },
		{ .addr = 0x00000d, .byte = 0x82 },
		{ .addr = 0x00000e, .byte = 0x55 },
		{ .addr = 0x00000f, .byte = 0xa0 },
		{ .addr = 0x8255a0, .byte = 0xf0 },
		{ .addr = 0x8255a1, .byte = 0xdd },
		{ .addr = 0x8255a2, .byte = 0xde },
		{ .addr = 0x8255a3, .byte = 0x0d }
};

static const SST_RamByte rts_final_ram_31[] = {
		{ .addr = 0xc5dfd4, .byte = 0x4e },
		{ .addr = 0xc5dfd5, .byte = 0x75 },
		{ .addr = 0xc5dfd6, .byte = 0x62 },
		{ .addr = 0xc5dfd7, .byte = 0x4e },
		{ .addr = 0x7f5adc, .byte = 0x00 },
		{ .addr = 0x7f5add, .byte = 0xc5 },
		{ .addr = 0x7f5ade, .byte = 0xdf },
		{ .addr = 0x7f5adf, .byte = 0xd6 },
		{ .addr = 0x7f5ada, .byte = 0xa0 },
		{ .addr = 0x7f5adb, .byte = 0x1f },
		{ .addr = 0x7f5ad8, .byte = 0x4e },
		{ .addr = 0x7f5ad9, .byte = 0x75 },
		{ .addr = 0x7f5ad6, .byte = 0x96 },
		{ .addr = 0x7f5ad7, .byte = 0xf3 },
		{ .addr = 0x7f5ad2, .byte = 0x4e },
		{ .addr = 0x7f5ad3, .byte = 0x76 },
		{ .addr = 0x7f5ad4, .byte = 0x94 },
		{ .addr = 0x7f5ad5, .byte = 0x0b },
		{ .addr = 0x00000c, .byte = 0x7d },
		{ .addr = 0x00000d, .byte = 0x82 },
		{ .addr = 0x00000e, .byte = 0x55 },
		{ .addr = 0x00000f, .byte = 0xa0 },
...
static const SST_Transaction rts_transactions_31[] = {
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 8346332, .data = 37899, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 8346334, .data = 38643, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_RE,
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 759538, .data = 24016, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 8 },
	{
		...
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 8346334, .data = 57302, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 8346330, .data = 40991, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 8346332, .data = 197, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 8346328, .data = 20085, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 8346326, .data = 38643, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 8346322, .data = 20086, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_W,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 8346324, .data = 37899, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 12, .data = 32130, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 5, .addr = 14, .data = 21920, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{
		.kind = SST_TS_R,
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 8541600, .data = 61661, .uds = false, .lds = false, .is_word = false, 
		}
	},
	{ .kind = SST_TS_N, .cycles = 2 },
	{
		...
		.cycles = 4,
		.bus = {
			.fc = 6, .addr = 8541602, .data = 56845, .uds = false, .lds = false, .is_word = false, 
		}
	},
};
...
static const SST_TestCase rts[] = {
	...
	},
	{
		...
		.initial = {
			.regs = {
				4217826852, 2984733104, 1868190554, 502690542, 2069162487, 744137719, 3056290293, 1241437647, 3168628597, 961366000, 3522605680, 3542426696, 524726146, 3042997589, 4014807425, 8085634, 9910360, 32768, 3654502
			},
			.prefetch0 = 20085,
			.prefetch1 = 33447,
			.ram = rts_initial_ram_16,
			.ram_len = 12,
		},
		.final = {
			.regs = {
				4217826852, 2984733104, 1868190554, 502690542, 2069162487, 744137719, 3056290293, 1241437647, 3168628597, 961366000, 3522605680, 3542426696, 524726146, 3042997589, 4014807425, 8085638, 9910360, 32768, 1774794728
			},
			.prefetch0 = 46729,
			.prefetch1 = 61949,
			.ram = rts_final_ram_16,
			.ram_len = 12,
		},
		.transactions = rts_transactions_16,
		.transactions_len = 4,
		.lenght = 16,
	},
	{
		...
		.initial = {
			.regs = {
				3235117943, 1263528734, 2775443798, 3700016438, 2318364421, 4196221308, 1278410369, 2140558208, 4162086463, 2019295094, 3874815938, 2685004410, 3903857696, 4223358253, 2705816195, 1761530, 9010922, 523, 10284674
			},
			.prefetch0 = 20085,
			.prefetch1 = 52372,
			.ram = rts_initial_ram_17,
			.ram_len = 12,
		},
		.final = {
			.regs = {
				3235117943, 1263528734, 2775443798, 3700016438, 2318364421, 4196221308, 1278410369, 2140558208, 4162086463, 2019295094, 3874815938, 2685004410, 3903857696, 4223358253, 2705816195, 1761534, 9010922, 523, 1650669370
			},
			.prefetch0 = 12885,
			.prefetch1 = 59639,
			.ram = rts_final_ram_17,
			.ram_len = 12,
		},
		.transactions = rts_transactions_17,
		.transactions_len = 4,
		.lenght = 16,
	},
	{
		...
		.initial = {
			.regs = {
				1297519033, 3223746749, 1237591047, 3672871219, 975336958, 4103403916, 3891483998, 501680865, 4251396995, 1793128654, 2653336708, 2702240618, 215914558, 1536759857, 2654772950, 11964382, 2821098, 40960, 16169594
			},
			.prefetch0 = 20085,
			.prefetch1 = 19818,
			.ram = rts_initial_ram_18,
			.ram_len = 12,
		},
		.final = {
			.regs = {
				1297519033, 3223746749, 1237591047, 3672871219, 975336958, 4103403916, 3891483998, 501680865, 4251396995, 1793128654, 2653336708, 2702240618, 215914558, 1536759857, 2654772950, 11964382, 2821102, 40960, 200455926
			},
			.prefetch0 = 14441,
			.prefetch1 = 52320,
			.ram = rts_final_ram_18,
			.ram_len = 12,
		},
		.transactions = rts_transactions_18,
		.transactions_len = 4,
		.lenght = 16,
	},
	{
		...
		.initial = {
			.regs = {
				2780703642, 1893413680, 1062737238, 1257059364, 3226006514, 2066254172, 4179706572, 618235953, 2082044427, 3048973939, 2892341185, 840261440, 3328985129, 3689529875, 508502467, 1211216, 13695398, 34325, 10850514
			},
			.prefetch0 = 20085,
			.prefetch1 = 16537,
			.ram = rts_initial_ram_19,
			.ram_len = 16,
		},
		.final = {
			.regs = {
				2780703642, 1893413680, 1062737238, 1257059364, 3226006514, 2066254172, 4179706572, 618235953, 2082044427, 3048973939, 2892341185, 840261440, 3328985129, 3689529875, 508502467, 1211220, 13695384, 9749, 3502664218
			},
			.prefetch0 = 22215,
			.prefetch1 = 44139,
			.ram = rts_final_ram_19,
			.ram_len = 30,
		},
		.transactions = rts_transactions_19,
		.transactions_len = 16,
		.lenght = 66,
	},
	{
		...
		.initial = {
			.regs = {
				3777415768, 1050160941, 2950026099, 1257571943, 705844497, 4050927517, 3407058138, 2050027411, 3803900673, 32322851, 3641885151, 1394853007, 4122341469, 3939863865, 1261930390, 1316060, 8633478, 1025, 3179082
			},
			.prefetch0 = 20085,
			.prefetch1 = 33705,
			.ram = rts_initial_ram_20,
			.ram_len = 12,
		},
		.final = {
			.regs = {
				3777415768, 1050160941, 2950026099, 1257571943, 705844497, 4050927517, 3407058138, 2050027411, 3803900673, 32322851, 3641885151, 1394853007, 4122341469, 3939863865, 1261930390, 1316064, 8633478, 1025, 2606386154
			},
			.prefetch0 = 63834,
			.prefetch1 = 21066,
			.ram = rts_final_ram_20,
			.ram_len = 12,
		},
		.transactions = rts_transactions_20,
		.transactions_len = 4,
		.lenght = 16,
	},
	{
		...
		.initial = {
			.regs = {
				4083475985, 1950516032, 569035841, 995148993, 163755567, 2655342210, 2857096817, 2989254891, 885673988, 545138219, 732136595, 4275680528, 2720432349, 249411166, 3342108107, 7518506, 5625436, 1808, 2812762
			},
			.prefetch0 = 20085,
			.prefetch1 = 4856,
			.ram = rts_initial_ram_21,
			.ram_len = 16,
		},
		.final = {
			.regs = {
				4083475985, 1950516032, 569035841, 995148993, 163755567, 2655342210, 2857096817, 2989254891, 885673988, 545138219, 732136595, 4275680528, 2720432349, 249411166, 3342108107, 7518510, 5625422, 10000, 3731902796
			},
			.prefetch0 = 11362,
			.prefetch1 = 55078,
			.ram = rts_final_ram_21,
			.ram_len = 30,
		},
		.transactions = rts_transactions_21,
		.transactions_len = 16,
		.lenght = 66,
	},
	{
		...
		.initial = {
			.regs = {
				3692958041, 460859894, 2731334504, 1208563394, 1416809081, 3816203468, 3167750451, 837900600, 1075374291, 1338459653, 1496880295, 2114895630, 640858872, 3900640555, 953661083, 12637566, 1405306, 1549, 8317070
			},
			.prefetch0 = 20085,
			.prefetch1 = 10137,
			.ram = rts_initial_ram_22,
			.ram_len = 16,
		},
		.final = {
			.regs = {
				3692958041, 460859894, 2731334504, 1208563394, 1416809081, 3816203468, 3167750451, 837900600, 1075374291, 1338459653, 1496880295, 2114895630, 640858872, 3900640555, 953661083, 12637570, 1405292, 9741, 3573553276
			},
			.prefetch0 = 54433,
			.prefetch1 = 41172,
			.ram = rts_final_ram_22,
			.ram_len = 30,
		},
		.transactions = rts_transactions_22,
		.transactions_len = 16,
		.lenght = 66,
	},
	{
		...
		.initial = {
			.regs = {
				1898033881, 1811271099, 762310748, 3084840365, 3437758328, 2403426759, 1333506420, 3449312924, 1326125217, 3716708631, 78438388, 3757283796, 2457750748, 3433934081, 3226381605, 4639664, 603418, 34048, 12486558
			},
			.prefetch0 = 20085,
			.prefetch1 = 13632,
			.ram = rts_initial_ram_23,
			.ram_len = 16,
		},
		.final = {
			.regs = {
				1898033881, 1811271099, 762310748, 3084840365, 3437758328, 2403426759, 1333506420, 3449312924, 1326125217, 3716708631, 78438388, 3757283796, 2457750748, 3433934081, 3226381605, 4639668, 603404, 9472, 2739553566
			},
			.prefetch0 = 58968,
			.prefetch1 = 47990,
			.ram = rts_final_ram_23,
			.ram_len = 30,
		},
		.transactions = rts_transactions_23,
		.transactions_len = 16,
		.lenght = 66,
	},
	{
		...
		.initial = {
			.regs = {
				1768918166, 3331862224, 3389844198, 3287576150, 227627148, 2990368265, 3796808498, 1498863056, 1911545184, 2613211578, 207185971, 134636844, 1493261765, 3583001443, 2332898210, 1044734, 2904936, 34322, 6337046
			},
			.prefetch0 = 20085,
			.prefetch1 = 16368,
			.ram = rts_initial_ram_24,
			.ram_len = 12,
		},
		.final = {
			.regs = {
				1768918166, 3331862224, 3389844198, 3287576150, 227627148, 2990368265, 3796808498, 1498863056, 1911545184, 2613211578, 207185971, 134636844, 1493261765, 3583001443, 2332898210, 1044738, 2904936, 34322, 1006175094
			},
			.prefetch0 = 56058,
			.prefetch1 = 12743,
			.ram = rts_final_ram_24,
			.ram_len = 12,
		},
		.transactions = rts_transactions_24,
		.transactions_len = 4,
		.lenght = 16,
	},
	{
		...
		.initial = {
			.regs = {
				3581526171, 1182442293, 1586449751, 4223749546, 200028999, 946557551, 2385224234, 4015976800, 1720034700, 631370218, 2750341110, 1278300760, 2628615085, 4082851747, 3178382692, 8650992, 11662536, 1547, 717714
			},
			.prefetch0 = 20085,
			.prefetch1 = 3623,
			.ram = rts_initial_ram_25,
			.ram_len = 16,
		},
		.final = {
			.regs = {
				3581526171, 1182442293, 1586449751, 4223749546, 200028999, 946557551, 2385224234, 4015976800, 1720034700, 631370218, 2750341110, 1278300760, 2628615085, 4082851747, 3178382692, 8650996, 11662522, 9739, 1509996858
			},
			.prefetch0 = 16809,
			.prefetch1 = 3745,
			.ram = rts_final_ram_25,
			.ram_len = 30,
		},
		.transactions = rts_transactions_25,
		.transactions_len = 16,
		.lenght = 66,
	},
	{
		...
		.initial = {
			.regs = {
				3712847288, 494313921, 1455765890, 751442263, 3293603829, 2328314435, 278102690, 3795224725, 3123048587, 3507380702, 4073225573, 1071192456, 350942531, 3159213044, 3668987479, 16045898, 11268610, 34322, 10822978
			},
			.prefetch0 = 20085,
			.prefetch1 = 4885,
			.ram = rts_initial_ram_26,
			.ram_len = 12,
		},
		.final = {
			.regs = {
				3712847288, 494313921, 1455765890, 751442263, 3293603829, 2328314435, 278102690, 3795224725, 3123048587, 3507380702, 4073225573, 1071192456, 350942531, 3159213044, 3668987479, 16045902, 11268610, 34322, 3856520454
			},
			.prefetch0 = 24590,
			.prefetch1 = 10096,
			.ram = rts_final_ram_26,
			.ram_len = 12,
		},
		.transactions = rts_transactions_26,
		.transactions_len = 4,
		.lenght = 16,
	},
	{
		...
		.initial = {
			.regs = {
				3822947841, 2226554800, 4051012210, 2934890956, 2738558520, 3596515366, 2575772899, 575637581, 1677979685, 2436884509, 1914139699, 4123259347, 2655902183, 4113963907, 2307387871, 1427798, 11674584, 9230, 6793394
			},
			.prefetch0 = 20085,
			.prefetch1 = 38068,
			.ram = rts_initial_ram_27,
			.ram_len = 16,
		},
		.final = {
			.regs = {
				3822947841, 2226554800, 4051012210, 2934890956, 2738558520, 3596515366, 2575772899, 575637581, 1677979685, 2436884509, 1914139699, 4123259347, 2655902183, 4113963907, 2307387871, 1427798, 11674574, 9230, 1932680254
			},
			.prefetch0 = 53239,
			.prefetch1 = 63289,
			.ram = rts_final_ram_27,
			.ram_len = 26,
		},
		.transactions = rts_transactions_27,
		.transactions_len = 16,
		.lenght = 66,
	},
	{
		...
		.initial = {
			.regs = {
				1966073530, 368200612, 1997870649, 4134488220, 1516099195, 2676899467, 3162340207, 3258638224, 2726610302, 3889036526, 178507541, 3362300905, 2441369908, 1516464606, 2141913138, 11542778, 5568372, 8196, 16320838
			},
			.prefetch0 = 20085,
			.prefetch1 = 30574,
			.ram = rts_initial_ram_28,
			.ram_len = 16,
		},
		.final = {
			.regs = {
				1966073530, 368200612, 1997870649, 4134488220, 1516099195, 2676899467, 3162340207, 3258638224, 2726610302, 3889036526, 178507541, 3362300905, 2441369908, 1516464606, 2141913138, 11542778, 5568362, 8196, 918456898
			},
			.prefetch0 = 51149,
			.prefetch1 = 32945,
			.ram = rts_final_ram_28,
			.ram_len = 26,
		},
		.transactions = rts_transactions_28,
		.transactions_len = 16,
		.lenght = 66,
	},
	{
		...
		.initial = {
			.regs = {
				26526613, 3608699150, 1705881150, 3962556261, 3036878469, 944945218, 3680867326, 3083934415, 1186332521, 1177066971, 3284004746, 47008116, 524642497, 4152550189, 1957829236, 8018562, 15772002, 32768, 9812220
			},
			.prefetch0 = 20085,
			.prefetch1 = 20337,
			.ram = rts_initial_ram_29,
			.ram_len = 16,
		},
		.final = {
			.regs = {
				26526613, 3608699150, 1705881150, 3962556261, 3036878469, 944945218, 3680867326, 3083934415, 1186332521, 1177066971, 3284004746, 47008116, 524642497, 4152550189, 1957829236, 8018566, 15771988, 8192, 550425774
			},
			.prefetch0 = 19875,
			.prefetch1 = 49685,
			.ram = rts_final_ram_29,
			.ram_len = 30,
		},
		.transactions = rts_transactions_29,
		.transactions_len = 16,
		.lenght = 66,
	},
	{
		...
		.initial = {
			.regs = {
				1653658358, 2007320954, 1263068031, 4148077795, 1942161964, 396376251, 3480812497, 2821496915, 753360579, 620031873, 2107367496, 3804815969, 929121213, 3142131873, 742677758, 331988, 16532790, 33811, 11341420
			},
			.prefetch0 = 20085,
			.prefetch1 = 7614,
			.ram = rts_initial_ram_30,
			.ram_len = 12,
		},
		.final = {
			.regs = {
				1653658358, 2007320954, 1263068031, 4148077795, 1942161964, 396376251, 3480812497, 2821496915, 753360579, 620031873, 2107367496, 3804815969, 929121213, 3142131873, 742677758, 331992, 16532790, 33811, 3406705264
			},
			.prefetch0 = 17035,
			.prefetch1 = 22816,
			.ram = rts_final_ram_30,
			.ram_len = 12,
		},
		.transactions = rts_transactions_30,
		.transactions_len = 4,
		.lenght = 16,
	},
	{
		...
		.initial = {
			.regs = {
				3749389290, 4087037221, 2225143846, 2356005396, 605930912, 3091678132, 2877324795, 1031073242, 1897917780, 2808507502, 3549656276, 3663756988, 1423316714, 2925468714, 1706772528, 13384512, 8346332, 40991, 12967896
			},
			.prefetch0 = 20085,
			.prefetch1 = 25166,
			.ram = rts_initial_ram_31,
			.ram_len = 16,
		},
		.final = {
			.regs = {
				3749389290, 4087037221, 2225143846, 2356005396, 605930912, 3091678132, 2877324795, 1031073242, 1897917780, 2808507502, 3549656276, 3663756988, 1423316714, 2925468714, 1706772528, 13384512, 8346322, 8223, 2105693604
			},
			.prefetch0 = 61661,
			.prefetch1 = 56845,
			.ram = rts_final_ram_31,
			.ram_len = 26,
		},
		.transactions = rts_transactions_31,
		.transactions_len = 16,
		.lenght = 66,
	},
};
