...
enum {
	...
	_MMU_APRAM_SIZE = 64 * 1024, // 64KB (Audio Processor RAM)
	_MMU_MMIO_REGION_SIZE = 256, // Each MMIO region is 256-bytes wide

	_MMU_RAM_ADDR = 0x00'0000,
	_MMU_ROM_ADDR = 0xf0'0000,
	_MMU_APRAM_ADDR = 0xf9'0000,

	_MMU_MMIO_VDP_ADDR = 0xfa'0000,
	_MMU_MMIO_IO_ADDR = 0x0fa'0100,
	_MMU_MMIO_SD_ADDR = 0xfa'0200,
	_MMU_MMIO_DBG_ADDR = 0xfa'0300,
	...
	_MMU_RESERVED_DTACK_SIZE = 0x64 * 1024 * 2, // 128KB is reserved and does nothing
};
